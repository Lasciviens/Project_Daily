...
export function PlanThisButton({
  ...
  return (
    /* Popover uses Floating UI internally — no absolute positioning or click-outside needed */
    <Popover className="relative">
      ...
      <PopoverPanel
        anchor="top start"
        transition
        className="z-30 card p-3 w-52 max-w-[calc(100vw-2rem)] shadow-lg [--anchor-gap:6px] transition duration-150 data-[closed]:opacity-0 data-[closed]:scale-95"
      >
        {plannedFor ? (
