...
export const STEPS_EXTRA_METRICS: MiniMetricConfig[] = [
  ...
  { metric: 'walking_step_length', icon: '📏', title: 'Step Length', unit: 'cm', decimals: 1,
  ...
  { metric: 'walking_double_support_percentage', icon: '🦶', title: 'Double Support', unit: '%', decimals: 1,
  ...
  { metric: 'stair_speed_up', icon: '⬆️', title: 'Stair Speed Up', unit: 'm/s', decimals: 2,
    description: 'How fast you climb stairs — Apple’s cardio-fitness proxy from the Watch.' },
  { metric: 'stair_speed_down', icon: '⬇️', title: 'Stair Speed Down', unit: 'm/s', decimals: 2,
    description: 'How fast you descend stairs — a balance & mobility indicator.' },
  { metric: 'six_minute_walking_test_distance', icon: '📍', title: '6-Min Walk', unit: 'm', decimals: 0,
  ...
  { metric: 'cycling_distance', icon: '🚲', title: 'Cycling Distance', unit: 'km', decimals: 2,
...
export const SLEEP_EXTRA_METRICS: MiniMetricConfig[] = [
  ...
  { metric: 'blood_oxygen_saturation', icon: '🫁', title: 'Blood Oxygen', unit: '%', decimals: 0,
    description: 'Overnight SpO2 from the Watch — sustained dips can flag breathing disturbances.' },
  { metric: 'breathing_disturbances', icon: '🌬️', title: 'Breathing Disturbances', unit: 'count', decimals: 1,
