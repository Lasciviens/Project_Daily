...
import { TgRanksContext } from './components/tgRanks'
...
export function TestGamePage() {
  ...
  const listKey = [section, effectivePlatform, effectiveScopePlatform, statuses.join(','), pickedGenres.join(','), sort, search.trim()].join('|')
