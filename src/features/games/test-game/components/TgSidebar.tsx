...
import {
  Archive, ArrowLeft, ChartColumn, CircleCheckBig, Heart, SlidersHorizontal, SquarePlay,
} from 'lucide-react'
  ...
  return (
    ...
    >
      ...
      <div className="shrink-0 border-t border-[var(--tg-border)] px-2.5 pb-2.5 pt-1.5">
        ...
        <Link
          to="/games"
          className="mt-0.5 flex min-h-[30px] items-center gap-2 rounded-[10px] px-3 text-[12px] font-medium text-[var(--tg-muted)] transition-colors [@media(hover:hover)]:hover:bg-[var(--tg-hover)] [@media(hover:hover)]:hover:text-[var(--tg-text)] [@media(pointer:coarse)]:min-h-[44px]"
        >
