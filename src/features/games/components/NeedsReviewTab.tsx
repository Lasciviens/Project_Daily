...
// something real (a cover, any genre, a release year, a platform, a primary
// variant) or explicitly flagged needs_review — the reasons come from
// testGameModel.needsReviewReasons. See migration
...
/**
 * The list the Games page computed from rows it already holds
 * (testGameModel.needsReviewList) — no fetch here, so no failure mode of its own.
 */
