...
|---|---|---|---|---|
| 0 | Source-aware foundation (schema + aggregation) | 🔴 **REDESIGN IN PROGRESS — do not merge PR #351 as-is.** Critical empirical finding: within-Apple multi-stream double-counting (steps/energy) is a real, pre-existing, live-data-confirmed bug, unrelated to Fitbit. See Decision Log 2026-07-21. | No | — |
